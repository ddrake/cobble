...
class Cobble extends Object {
 ...
 public $queries_info = array(
    'theme_view' => array(
      ...
      'colheads'=>array('Theme', 'Theme Handle', 'Description', 'Package Handle', 'Directory','Installed?', 'Overridden?', 'Site Theme?')
    ),
    'page_type_view' => array(
      ...
      'colheads'=>array('Theme', 'Page Type', 'Page Type Handle', 'File Prefix', 'File Path', 'Wrapper Path', 'Package Handle', 'SP Handle Conflict?')
    ),
    'page_view' => array(
      'name'=>'Pages',
      ...
      'colheads'=>array('cID', 'cFilename', 'Handle', 'Page Type Handle', 'filePath', 'wrapperPath', 'Single Page?', 'Theme From Path?', 'Page Defaults Template?', 'Wrapper Missing?', 'File Missing?', 'Alias?', 'Ext. Link?')
    ),
    'area_view' => array(
      'name'=>'Areas',
      ...
      'colheads'=>array('Page Handle or Defaults Type', 'cID', 'Area Handle', 'File Path', 'Handle Duplicated?', 'Global Area?', 'Global Template Path', 'Global Scrapbook', 'Block Count')
    )
  );
  ...
  public $queries_diag = array(
    ...
    'page_type_sp_conflict' => array(
      ...
      'colheads'=>array('Theme', 'Page Type', 'Page Type Handle', 'File Prefix', 'File Path', 'Wrapper Path', 'Package Handle')
    ),
    ...
    function ctHandleText($ctHandle, $isSinglePage, $isAlias, $isExternalLink) {
      if (empty($ctHandle)) {
        if (!empty($isExternalLink)) {
          $rslt = "N/A (ext. link)";
        } else if (!empty($isAlias)) {
          $rslt = "N/A (alias)";
        } else if (!empty($isSinglePage)) {
