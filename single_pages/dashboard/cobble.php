...
<div class="ccm-dashboard-inner">
  ...
  <table border="0" cellpadding="3"><tr>
	...
	<td><?php echo $form->select('query_info', $queries_info, array('onChange' => 'document.getElementById(\'query_diag\').selectedIndex = 0; this.form.submit();')) ?></td>
  </tr><tr>
	<td align="right"><?php echo t('Diagnostic Queries:') ?></td>
	<td><?php echo $form->select('query_diag', $queries_diag, array('onChange' => 'document.getElementById(\'query_info\').selectedIndex = 0; this.form.submit();')) ?></td>
  </tr></table>
	</form>
  ...
  <div style="max-width: 60em; margin-top: 10px;">
    ...
    <?php } else { ?>
    <form style="display: inline; margin-left: 20px" method="post" id="ccm-cobble-query" action="<?php echo $this->action('send_csv') ?>">
